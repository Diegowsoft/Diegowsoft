<!---- Banner Header ---->
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=2733dd&height=250&section=header&text=Diego+Fagundes&fontSize=90&fontColor=ffffff&animation=fadeIn" alt="Banner Diego Fagundes" width="100%" />
</div>
...
UNINTER - Centro Universitário Internacional — 2026-2028  
<br>
**Ciência de Dados**  
...
*Nov 2025*  
✔ Desenvolvimento de documentações técnicas internas para o time de licenciamento e externas para os clientes;

✔ Prototipagem seguindo padrões de UI/UX;

✔ Desenvolvimento de POCs e MVPs de documentações;

✔ Integração com APIs, desenvolvimento de recursos de acessibilidade para PCDs.

✔ Suporte Técnico: através do Zendesk atuo garantindo que não faltem licenças aos clientes nem haja excedentes.  


## 2. Imersão Start Tech Cloud — TOTVS 

*Mai 2025 - Set 2025*  
✔ Apadrinhamento: Acompanhamento do dia a dia dos meus padrinhos, observando rotinas, processos, desafios e boas práticas de Governança em TI como: Problema, Mudança, Hierarquia de requisições, ITSM, CMDB, ICs, treinamento de ITIL, treinamento para certificação Exin Cloud Computing Foundation;

✔ Treinamento de CX: Mapeamento de Personas, Criação de dashboards e Formulários;

✔ BX, CX, UX e UI: Foco na experiência do usuário, cliente e negócio.;

✔ Trabalho em equipe: Comunicação, colaboração e desenvolvimento conjunto;

✔ AWS Cloud:  armazenamento EC2, infraestrutura, nuvem pública, privada, comunitária, híbrida, IaaS, SaaS, PaaS;

✔ Google Cloud: Conhecimento geral da plataforma como FinOps, Análise de CUD, Compute Engine, Load Balance, IAC, Terraform;

✔ DevOps: GitLab, Github Actions, Git, GitHub, Container, Docker, Kubernetes;
